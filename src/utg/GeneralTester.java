...
public class GeneralTester {
     ...
     * See main.RunningCourseActivity for more info.
     *
     * Unless otherwise altered, addition must follow the convention:
     *  RunningCourseActivity.STARTUP_REGISTRATIONS.add(main.RunningCourse)
     */
    private static void forgeActiveCoursesForTest(){
        RunningCourseActivity.STARTUP_REGISTRATIONS.add(new RunningCourse("MTH310","Number Theory",
                "Murphy Egwe","Brikama","Chancery rom 3","","",true));
        RunningCourseActivity.STARTUP_REGISTRATIONS.add(new RunningCourse("CPS204","Database Systems 1",
     ...
     *
     * Unless otherwise altered, addition must follow the convention:
     *  ModuleHandler.STARTUP_COURSES.add(main.Course)
     */
    private static void forgeCoursesForTest(){
        //2016/17
        ModuleHandler.STARTUP_COURSES.add(new Course("2016/2017","First Semester","gel101","Use of English 1","","","","",68,3,"",true));
        ModuleHandler.STARTUP_COURSES.add(new Course("2016/2017","First Semester","mth002","Pre-Calculus","","","","",77,3,"",true));
        //2017/18
        ModuleHandler.STARTUP_COURSES.add(new Course("2017/2018","First Semester","mth207","Introduction to Proofs","","","","",96.2,3,"",true));
        ModuleHandler.STARTUP_COURSES.add(new Course("2017/2018","First Semester","mth203","Linear Algebra 1","","","","",72,3,"",true));
        ModuleHandler.STARTUP_COURSES.add(new Course("2017/2018","First Semester","iss102","Introduction to Islam and the History of Islamic Sciences","","","","",90,3,"",true));
        ModuleHandler.STARTUP_COURSES.add(new Course("2017/2018","First Semester","mth201","Intermediate Calculus 1","","","","",79,3,"",true));
        ModuleHandler.STARTUP_COURSES.add(new Course("2017/2018","First Semester","mth102","Calculus 2","","","","",87,3,"",true));
        ModuleHandler.STARTUP_COURSES.add(new Course("2017/2018","Second Semester","mth2022","Intermediate Calculus 2".toUpperCase(),"Murphy Egwe","","","",71,3,"",true));
        ModuleHandler.STARTUP_COURSES.add(new Course("2017/2018","Second Semester","mth2051","Differential Equations 1".toUpperCase(),"Keeba Bah","","","",85,3,"",true));
        ModuleHandler.STARTUP_COURSES.add(new Course("2017/2018","Second Semester","der122","General Chemistry 2","Anthony Adjivon","","","",76,3,"",true));
        ModuleHandler.STARTUP_COURSES.add(new Course("2017/2018","Second Semester","cps111","Introduction to Information Communication Technology","Ebrima Sarr","","","",70,3,"",true));
        ModuleHandler.STARTUP_COURSES.add(new Course("2017/2018","Second Semester","cps101","Computer Programming 1","Fred Sangol","","","",80,3,"",true));
        //...
    }
